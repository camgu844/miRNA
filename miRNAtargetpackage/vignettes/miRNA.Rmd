...
```{r}
tmp = miRNA_target_interactions("stem-loop miRNA", "sepcific method", "hsa-mir-212",  "pictar5")
print(tmp$extract())
print(jsonlite::toJSON(tmp$extract()))
```
_Note_: only extract method available for database as data source.
...
```{r}
tmp = miRNA_target_interactions("mature miRNA", "sepcific method", "hsa-mir-212-3p",  "targetscan")
print(tmp$extract())
print(jsonlite::toJSON(tmp$extract()))
```
_Note_: only extract method available for database as data source.
